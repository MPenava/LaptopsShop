                        ...
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><i class="far fa-money-bill-alt"></i>&nbsp;&nbsp;<?= number_format($row["product_price"],2)?> KM</td>
                                    <input type="hidden" class="pprice" value="<?= $row["product_price"]?>">
                                    <td><input type="number"  class="form-control itemQty" value="<?=$row["qty"]?>" style="width:75px;"></td>
                                    <td><i class="far fa-money-bill-alt"></i>&nbsp;&nbsp;<?= number_format($row["total_price"],2)?> KM</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><b><i class="fas fa-money-bill-alt"></i>&nbsp;&nbsp;<?= number_format($grand_total,2)?> KM </b></td>
                                    <td>
                                        <a href="#" class="btn btn-primary <?= ($grand_total>1)?"":"disabled";?>"><i class="far fa-credit-card"></i>&nbsp;&nbsp;Checkout</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
